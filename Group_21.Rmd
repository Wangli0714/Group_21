...
```
Figure 2 shows the top 5 happiest countries. Finland gets the highest happy score with 7.842, followed by Denmark at 7.62. in addition, the differences between those five countries are small, less than 0.4, and all scores are greater than 7.4. 

```{r radarplot, echo = FALSE, eval = TRUE,out.width='70%', fig.pos = 'H', fig.align = "center", fig.cap = "\\label{fig:radar} Comparisons between Finland and the UK from six indexes."}
